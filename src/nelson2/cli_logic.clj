...
(defn cluster-command [command]
  (cond
    ...
    (= command "@expand-logic-thread") (do (print "Enter the logic thread [:a :b....]:- ") (flush)
    ...
    (= command "@sample-response") (do (print "Enter a sentence :- ") (flush) (logic-process/sample-response-mode (read-line)))
